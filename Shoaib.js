...
// Q no:20
let cities = ["shahdadkot", "karachi", "jamshoro", "sukker", "hyderabab"];
console.log(cities);
// Q no:21
...
// Q no:22
let myArray = [1, 2, 3]; // Array of numbers
...
// Q no:28
let age = 30; // Assign a value to age
if (age < 2) {
...
// Q no:30
let usernames = ["admin", "Shoaib", "Waqar", "Ali", "Mawaz"];
...
// Q no:32
let current_users = ["Shoaib", "Nawaz", "Ali", "Khan", "Qasim"];
let new_users = ["Haider", "Saleem", "Akhtar", "Shoaib", "Manzoor"];
...
// Q no:34
let favorite_pizzas = ["cheesiPizza", "cheese", "chickenPizza"];
...
// Q no:38
let describeCity = function (city, country = "USA") {
...
console.log(album3);
// Q no:41
let magicians = ["David Copperfield", "Penn & Teller", "Criss Angel"];
...
// Q no:42
let make_great1 = (() => {
    let magician_names = ["dai vernon", "harry", "david", "doug henning"];
    console.log("Initial magician names:", magician_names);
})();
// Q no:43 
const magicians = ["magician1", "magician2"];
